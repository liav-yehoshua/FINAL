...
2. **חלץ את הקובץ** באמצעות הסיסמה:
   - **איך להשיג את הסיסמה:** הסיסמה זמינה בהגשה ב-Moodle 
   - **אם אין לך גישה לסיסמה:** עליך ליצור מפתחות API משלך כמתואר בסעיף [איך להשיג מפתחות API משלך](#איך-להשיג-מפתחות-api-משלך-אופציונלי) למטה
